...
def networkLib():
    ...
    if len(libios[1]) != 0:
        try:
            urlretrieve("https://github.com/jayluxferro/custom-flutter-engines/releases/download/" + verUrl + libios[
                1] + "/Flutter", "Flutter")
        except:
            libios = '', ''
            notexcept("Flutter")
    if len(libAppArm64[1]) != 0:
        try:
            urlretrieve(
                "https://github.com/jayluxferro/custom-flutter-engines/releases/download/" + verUrl + libAppArm64[
    ...
    if len(libAppArm[1]) != 0:
        try:
            urlretrieve(
                "https://github.com/jayluxferro/custom-flutter-engines/releases/download/android-" + verUrl + libAppArm[
    ...
    if len(libAppX64[1]) != 0:
        try:
            urlretrieve(
                "https://github.com/jayluxferro/custom-flutter-engines/releases/download/android-" + verUrl + libAppX64[
    ...
    if len(libAppX86[1]) != 0:
        try:
            urlretrieve(
                "https://github.com/jayluxferro/custom-flutter-engines/releases/download/android-" + verUrl + libAppX86[
